...
export const sponsorImages = [
  {
    name: { en: 'Colors Marathi', mr: 'कलर्स मराठी' },
    logo: '/images/Colors marathi.png',
    images: ['/images/Colors marathi.png', '/images/ganpati-hero.svg', '/images/community.svg'],
    message: 'Thank you for supporting Hukmill Lane Cha Raja.',
    alt: { en: 'Colors Marathi logo', mr: 'कलर्स मराठी लोगो' },
  },
  {
    name: { en: 'Kesh King', mr: 'केश किंग' },
    logo: '/images/Kesh.webp',
    images: ['/images/Kesh.webp', '/images/ganpati-hero.svg', '/images/cultural-program.svg'],
    message: 'Thank you for supporting Hukmill Lane Cha Raja.',
    alt: { en: 'Kesh King logo', mr: 'केश किंग लोगो' },
  },
  {
    name: { en: 'RR Kabel', mr: 'आरआर केबळ' },
    logo: '/images/rr.png',
    images: ['/images/rr.png', '/images/panlogo.png', '/images/sponsor-diya.svg'],
    message: 'Thank you for supporting Hukmill Lane Cha Raja.',
    alt: { en: 'RR Kabel logo', mr: 'आरआर केबळ लोगो' },
  },
  {
    name: { en: 'CP Plus', mr: 'सीपी प्लस' },
    logo: '/images/cp.png',
    images: ['/images/cp.png', '/images/mandal-courtyard.svg', '/images/sponsor-lotus.svg'],
    message: 'Thank you for supporting Hukmill Lane Cha Raja.',
    alt: { en: 'CP Plus logo', mr: 'सीपी प्लस लोगो' },
  },
  {
    name: { en: 'Rapido', mr: 'रैपिडो' },
    logo: '/images/rapido-removebg-preview.png',
    images: ['/images/rapido-removebg-preview.png', '/images/sponsor-leaf.svg', '/images/sponsor-diya.svg'],
    message: 'Thank you for supporting Hukmill Lane Cha Raja.',
    alt: { en: 'Rapido logo', mr: 'रैपिडो लोगो' },
  },
  {
    name: { en: 'Zee', mr: 'जी' },
    logo: '/images/zee.png',
    images: ['/images/zee.png', '/images/ganpati-hero.svg', '/images/deepotsav.svg'],
    message: 'Thank you for supporting Hukmill Lane Cha Raja.',
    alt: { en: 'Zee logo', mr: 'जी लोगो' },
  },
  {
    name: { en: 'VRT', mr: 'वीआरटी' },
    logo: '/images/vrt.png',
    images: ['/images/vrt.png', '/images/aarti-evening.svg', '/images/sponsor-leaf.svg'],
    message: 'Thank you for supporting Hukmill Lane Cha Raja.',
    alt: { en: 'VRT logo', mr: 'वीआरटी लोगो' },
  },
];
...
export const timeline = [
  {
    year: '1998',
    title: { en: 'A humble beginning', mr: 'à¤¸à¤¾à¤§à¥€ à¤¸à¥à¤°à¥à¤µà¤¾à¤¤' },
    text: { en: 'The first collective celebration began with local families.', mr: 'à¤¸à¥à¤¥à¤¾à¤¨à¤¿à¤• à¤•à¥à¤Ÿà¥à¤‚à¤¬à¤¾à¤‚à¤¸à¤¹ à¤ªà¤¹à¤¿à¤²à¤¾ à¤¸à¤¾à¤®à¥‚à¤¹à¤¿à¤• à¤‰à¤¤à¥à¤¸à¤µ à¤¸à¥à¤°à¥‚ à¤à¤¾à¤²à¤¾.' },
  },
  {
    year: '2008',
    title: { en: 'Cultural evenings grew', mr: 'à¤¸à¤¾à¤‚à¤¸à¥à¤•à¥ƒà¤¤à¤¿à¤• à¤¸à¤‚à¤§à¥à¤¯à¤¾à¤‚à¤šà¤¾ à¤µà¤¿à¤¸à¥à¤¤à¤¾à¤°' },
    text: { en: 'Music, childrenâ€™s performances, and bhajan programs became regular.', mr: 'à¤¸à¤‚à¤—à¥€à¤¤, à¤®à¥à¤²à¤¾à¤‚à¤šà¥‡ à¤•à¤¾à¤°à¥à¤¯à¤•à¥à¤°à¤® à¤†à¤£à¤¿ à¤­à¤œà¤¨ à¤¨à¤¿à¤¯à¤®à¤¿à¤¤ à¤à¤¾à¤²à¥‡.' },
  },
  {
    year: '2018',
    title: { en: 'Community seva focus', mr: 'à¤¸à¤®à¤¾à¤œ à¤¸à¥‡à¤µà¥‡à¤²à¤¾ à¤ªà¥à¤°à¤¾à¤§à¤¾à¤¨à¥à¤¯' },
    text: { en: 'The mandal strengthened volunteer-led local initiatives.', mr: 'à¤®à¤‚à¤¡à¤³à¤¾à¤¨à¥‡ à¤¸à¥à¤µà¤¯à¤‚à¤¸à¥‡à¤µà¤•à¤¾à¤‚à¤šà¥à¤¯à¤¾ à¤¸à¥à¤¥à¤¾à¤¨à¤¿à¤• à¤‰à¤ªà¤•à¥à¤°à¤®à¤¾à¤‚à¤¨à¤¾ à¤¬à¤³ à¤¦à¤¿à¤²à¥‡.' },
  },
  {
    year: '2026',
    title: { en: 'A calmer digital home', mr: 'à¤¶à¤¾à¤‚à¤¤ à¤¡à¤¿à¤œà¤¿à¤Ÿà¤² à¤˜à¤°' },
    text: { en: 'The mandal now carries its story online with simplicity.', mr: 'à¤®à¤‚à¤¡à¤³ à¤†à¤¤à¤¾ à¤†à¤ªà¤²à¥€ à¤•à¤¥à¤¾ à¤¸à¤¾à¤§à¥‡à¤ªà¤£à¤¾à¤¨à¥‡ à¤‘à¤¨à¤²à¤¾à¤‡à¤¨ à¤®à¤¾à¤‚à¤¡à¤¤à¥‡.' },
  },
];
